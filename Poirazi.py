...
def Dw(sig, w=5, s=1, norm=0):
    """
    Create a new signal by calculating euclidean distance of moving windows.

    Go through the signal summing the euclidean distance of each w points
    window in s steps. Making each signal more informative about the
    underlying content.
    """
    if norm == 1:
...
def loadAK(filename, numChannels, dtype):
    """
    Load electrodes data into memory, filename should be fpa+fpb+ele.
...
def loadQQ(N):
    ...
    fSig = ['C_Burst_Easy2_noise015.mat',
            'C_Difficult1_noise005.mat', 'C_Difficult1_noise01.mat',
            'C_Difficult1_noise015.mat', 'C_Difficult1_noise02.mat',
            'C_Difficult2_noise005.mat', 'C_Difficult2_noise01.mat',
            'C_Difficult2_noise015.mat', 'C_Difficult2_noise02.mat',
            'C_Drift_Easy2_noise015.mat',
            'C_Easy1_noise005.mat', 'C_Easy1_noise01.mat',
            'C_Easy1_noise015.mat', 'C_Easy1_noise01_short.mat',
            'C_Easy1_noise02.mat', 'C_Easy1_noise025.mat',
            'C_Easy1_noise03.mat', 'C_Easy1_noise035.mat',
            'C_Easy1_noise04.mat',
            'C_Easy2_noise005.mat', 'C_Easy2_noise01.mat',
            'C_Easy2_noise015.mat', 'C_Easy2_noise02.mat',
            'C_Test_LFPcorr_Easy2_noise015.mat',
            'times_C_Difficult1_noise015.mat'
            ]
...
def main(N):
    """
    Make this work for you by changing the paths to your need,
